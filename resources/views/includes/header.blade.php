                                                        ...
                                                        <div class="mini-product__info-wrapper">
                                                            <span class="mini-product__category">
                                                                @foreach ($cartProduct['product']->categories as $cat)
                                                                    <a
                                                                        href="shop-side-version-2.html">{{ $cat->name }}</a>
                                                                @endforeach
                                                            </span>
                                                            ...
                                                            <span
                                                                class="mini-product__quantity">{{ $cartProduct['amount'] }}x</span>

                                                            <span
                                                                class="mini-product__price">${{ number_format($cartProduct['product']->price) }}</span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="mini-product-stat">
                                        <div class="mini-total">
                                            ...
                                            <span class="subtotal-value">
                                                @if (session()->has('cart'))
                                                    ...
                                                    @foreach (session()->get('cart.products') as $cartProduct)
                                                        @php
                                                            number_format($total += $cartProduct['product']->price * $cartProduct['amount']);
                                                        @endphp
                                                    @endforeach
                                                    {{ number_format($total) }}
                                                @else
                                        ...
                                        <div class="mini-action">
                                            ...
                                            <a class="mini-link btn--e-transparent-secondary-b-2"
                                                href="{{ route('cart.index') }}">VIEWCART</a>
                                        </div>
                                    </div>
